...
import org.aksw.limes.core.measures.mapper.topology.contentsimilarity.no_indexing.ContentSimilarityAreaNoIndexing;
...
public class FDNoIndexingWrapper implements GeoMapper{

    @Override
    public AMapping getMapping(Map<String, Geometry> sourceData, Map<String, Geometry> targetData, String relation, int numThreads) {
        return ContentSimilarityDiagonalNoIndexing.getMapping(sourceData, targetData, relation, numThreads);
    }
    ...
    public AMapping getMapping(ACache source, ACache target, String sourceVar, String targetVar, String expression, double threshold, String relation, int numThreads) {
        return ContentSimilarityDiagonalNoIndexing.getMapping(source, target, sourceVar, targetVar, expression, threshold, relation, numThreads);
    }
